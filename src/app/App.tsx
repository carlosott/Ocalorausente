	...
	return (
		...
		>
			...
			<button
				onClick={onToggle}
				type="button"
				aria-label={isExpanded ? "Ocultar descrição" : "Ver descrição"}
				style={{
					width: "48px",
					height: "48px",
		...
		>
			...
			>
				<div>
					...
					>
						O Calor{" "}
						<em style={{ color: "#1B2B4B", fontStyle: "italic" }}>Ausente</em>
					</span>
				</div>
				<button
					type="button"
				...
				>
					<div className="flex flex-col gap-1.5" style={{ width: "22px" }}>
						<span
							style={{
								display: "block",
								height: "1px",
			...
			>
				...
				>
					...
					>
						A ausência que deixa <em style={{ color: "#1B2B4B" }}>marca</em>
					</h2>
					...
					>
						...
						<strong>ausência maternal na infância</strong> e os impactos
						emocionais que isso pode causar. As fotografias irão transmitir
						sentimentos como solidão, vazio e vulnerabilidade através de imagens
						sensíveis e simbólicas.
					</p>
					...
					>
						O ensaio, feito em <strong>preto e branco</strong>, utilizando luz,
						sombra e expressão para intensificar as emoções. Além disso, cada
						foto tem apenas um ponto de cor, usado como símbolo para destacar
						elementos importantes da narrativa.
					</p>
					...
					>
						As imagens são produzidas com o intuito de compor uma exposição
						fotográfica de cunho social{" "}
						<strong>
							sobre vulnerabilidade infantil após a perda materna por um
							feminicídio
						</strong>
						.
					</p>
				...
				<div style={{ display: "flex", flexDirection: "column" }}>
					{exhibitionPhotos.map((photo, i) => (
						<PhotoCard
							...
							onToggle={() => setExpandedPhoto(expandedPhoto === i ? null : i)}
						/>
					))}
				</div>
			</section>
			...
			>
				...
				>
					...
					>
						Visite a nossa <em style={{ opacity: 0.7 }}>exposição</em>
					</h2>
					...
					>
						A exposição{" "}
						<strong style={{ color: "#F0EDE6" }}>O Calor Ausente</strong> pode
						ser vivenciada presencialmente. As seis fotografias em preto e
						branco, cada uma com seu ponto de cor simbólico, convidam o
						visitante a refletir sobre a vulnerabilidade infantil e a ausência
						parental.
					</p>
			...
			>
				...
				>
					...
					>
						Duas visões, <em style={{ color: "#1B2B4B" }}>um ensaio</em>
					</h2>
			...
			>
				...
				>
					...
					>
						O Calor <em style={{ color: "#8A9AB4" }}>Ausente</em>
					</p>
					<p
						style={{
							fontFamily: "'DM Sans', sans-serif",
